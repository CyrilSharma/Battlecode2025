...
public class Attack {
    ...
    public static void soldierAttackMicro() throws GameActionException {
        ...
        System.out.println("[126] " + "actionReady = " + actionReady + ", " + "cooldownTurns = " + cooldownTurns);
        ...
        System.out.println("[143] " + "minDistToEnemy_N = " + minDistToEnemy_N + ", " + "targetLoc_N.x = " + targetLoc_N.x + ", " + "canMove_N = " + canMove_N + ", " + "targetLoc_N.y = " + targetLoc_N.y + ", " + "penalty_N = " + penalty_N + ", " + "healthDmgAttackRange_N = " + healthDmgAttackRange_N + ", " + "myHealthDmg_N = " + myHealthDmg_N + ", " + "towerHealth_N = " + towerHealth_N + ", " + "inActionRadius_N = " + inActionRadius_N);
        
        System.out.println("[143] " + "minDistToEnemy_NE = " + minDistToEnemy_NE + ", " + "targetLoc_NE.x = " + targetLoc_NE.x + ", " + "canMove_NE = " + canMove_NE + ", " + "targetLoc_NE.y = " + targetLoc_NE.y + ", " + "penalty_NE = " + penalty_NE + ", " + "healthDmgAttackRange_NE = " + healthDmgAttackRange_NE + ", " + "myHealthDmg_NE = " + myHealthDmg_NE + ", " + "towerHealth_NE = " + towerHealth_NE + ", " + "inActionRadius_NE = " + inActionRadius_NE);
        
        System.out.println("[143] " + "minDistToEnemy_E = " + minDistToEnemy_E + ", " + "targetLoc_E.x = " + targetLoc_E.x + ", " + "canMove_E = " + canMove_E + ", " + "targetLoc_E.y = " + targetLoc_E.y + ", " + "penalty_E = " + penalty_E + ", " + "healthDmgAttackRange_E = " + healthDmgAttackRange_E + ", " + "myHealthDmg_E = " + myHealthDmg_E + ", " + "towerHealth_E = " + towerHealth_E + ", " + "inActionRadius_E = " + inActionRadius_E);
        
        System.out.println("[143] " + "minDistToEnemy_SE = " + minDistToEnemy_SE + ", " + "targetLoc_SE.x = " + targetLoc_SE.x + ", " + "canMove_SE = " + canMove_SE + ", " + "targetLoc_SE.y = " + targetLoc_SE.y + ", " + "penalty_SE = " + penalty_SE + ", " + "healthDmgAttackRange_SE = " + healthDmgAttackRange_SE + ", " + "myHealthDmg_SE = " + myHealthDmg_SE + ", " + "towerHealth_SE = " + towerHealth_SE + ", " + "inActionRadius_SE = " + inActionRadius_SE);
        
        System.out.println("[143] " + "minDistToEnemy_S = " + minDistToEnemy_S + ", " + "targetLoc_S.x = " + targetLoc_S.x + ", " + "canMove_S = " + canMove_S + ", " + "targetLoc_S.y = " + targetLoc_S.y + ", " + "penalty_S = " + penalty_S + ", " + "healthDmgAttackRange_S = " + healthDmgAttackRange_S + ", " + "myHealthDmg_S = " + myHealthDmg_S + ", " + "towerHealth_S = " + towerHealth_S + ", " + "inActionRadius_S = " + inActionRadius_S);
        ...
        System.out.println("[143] " + "minDistToEnemy_W = " + minDistToEnemy_W + ", " + "targetLoc_W.x = " + targetLoc_W.x + ", " + "canMove_W = " + canMove_W + ", " + "targetLoc_W.y = " + targetLoc_W.y + ", " + "penalty_W = " + penalty_W + ", " + "healthDmgAttackRange_W = " + healthDmgAttackRange_W + ", " + "myHealthDmg_W = " + myHealthDmg_W + ", " + "towerHealth_W = " + towerHealth_W + ", " + "inActionRadius_W = " + inActionRadius_W);
        
        System.out.println("[143] " + "minDistToEnemy_NW = " + minDistToEnemy_NW + ", " + "targetLoc_NW.x = " + targetLoc_NW.x + ", " + "canMove_NW = " + canMove_NW + ", " + "targetLoc_NW.y = " + targetLoc_NW.y + ", " + "penalty_NW = " + penalty_NW + ", " + "healthDmgAttackRange_NW = " + healthDmgAttackRange_NW + ", " + "myHealthDmg_NW = " + myHealthDmg_NW + ", " + "towerHealth_NW = " + towerHealth_NW + ", " + "inActionRadius_NW = " + inActionRadius_NW);
        
        System.out.println("[143] " + "minDistToEnemy_C = " + minDistToEnemy_C + ", " + "targetLoc_C.x = " + targetLoc_C.x + ", " + "canMove_C = " + canMove_C + ", " + "targetLoc_C.y = " + targetLoc_C.y + ", " + "penalty_C = " + penalty_C + ", " + "healthDmgAttackRange_C = " + healthDmgAttackRange_C + ", " + "myHealthDmg_C = " + myHealthDmg_C + ", " + "towerHealth_C = " + towerHealth_C + ", " + "inActionRadius_C = " + inActionRadius_C);
        ...
        chooseBestNE: {
            ...
            else if (!inActionRadius_best && !inActionRadius_NE) {
        ...
        chooseBestE: {
            ...
            // If both squares are out of action radius, prefer the one which is closer.
            else if (!inActionRadius_best && !inActionRadius_E) {
        ...
        chooseBestS: {
            ...
            // If both squares are out of action radius, prefer the one which is closer.
            else if (!inActionRadius_best && !inActionRadius_S) {
        ...
        chooseBestSW: {
            ...
            // If both squares are out of action radius, prefer the one which is closer.
            else if (!inActionRadius_best && !inActionRadius_SW) {
        ...
        chooseBestW: {
            ...
            // If both squares are out of action radius, prefer the one which is closer.
            else if (!inActionRadius_best && !inActionRadius_W) {
        ...
        chooseBestNW: {
            ...
            // If both squares are out of action radius, prefer the one which is closer.
            else if (!inActionRadius_best && !inActionRadius_NW) {
        ...
        chooseBestC: {
            ...
            // If both squares are out of action radius, prefer the one which is closer.
            else if (!inActionRadius_best && !inActionRadius_C) {
        ...
        System.out.println("[158] " + "minDistToEnemy_best = " + minDistToEnemy_best + ", " + "targetLoc_best.x = " + targetLoc_best.x + ", " + "canMove_best = " + canMove_best + ", " + "targetLoc_best.y = " + targetLoc_best.y + ", " + "penalty_best = " + penalty_best + ", " + "healthDmgAttackRange_best = " + healthDmgAttackRange_best + ", " + "myHealthDmg_best = " + myHealthDmg_best + ", " + "towerHealth_best = " + towerHealth_best + ", " + "inActionRadius_best = " + inActionRadius_best);
