...
public class Pathing {
    ...
    public static void pathTo(MapLocation target) throws GameActionException {
        ...
        dists += "N=" + dist12 + " ";
        canMove = rc.canMove(Direction.NORTH);
        if (canMove && dist12 < bestDist) {
        ...
        dists += "NE=" + dist22 + " ";
        canMove = rc.canMove(Direction.NORTHEAST);
        if (canMove && dist22 < bestDist) {
        ...
        dists += "SE=" + dist20 + " ";
        canMove = rc.canMove(Direction.SOUTHEAST);
        if (canMove && dist20 < bestDist) {
        ...
        dists += "S=" + dist10 + " ";
        canMove = rc.canMove(Direction.SOUTH);
        if (canMove && dist10 < bestDist) {
        ...
        dists += "SW=" + dist00 + " ";
        canMove = rc.canMove(Direction.SOUTHWEST);
        if (canMove && dist00 < bestDist) {
        ...
        dists += "W=" + dist01 + " ";
        canMove = rc.canMove(Direction.WEST);
        if (canMove && dist01 < bestDist) {
        ...
        dists += "NW=" + dist02 + " ";
        canMove = rc.canMove(Direction.NORTHWEST);
        if (canMove && dist02 < bestDist) {
            bestDir = Direction.NORTHWEST;
            bestDist = dist02;
        }
        

        //rc.setIndicatorString("Left: " + (count - Clock.getBytecodeNum()));
    ...
    public static void greedy() throws GameActionException {
        ...
        if (bestLoc != null) {
            assert(bestLoc.distanceSquaredTo(currentTarget) < currentBugPosition.distanceSquaredTo(currentTarget));
            assert(!currentBugPosition.equals(bestLoc));
