...
public class RefuelManager {    
    ...
    public static void carefullyGoHome() throws GameActionException {
        ...
        
        {
            ...
            if (SquareManager.penalty11 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty11 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty11;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty12 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty12 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty12;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty13 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty13 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty13;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty21 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty21 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty21;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty22 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty22 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty22;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty23 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty23 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty23;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty31 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty31 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty31;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty32 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty32 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty32;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
        ...
        
        {
            ...
            if (SquareManager.penalty33 <= 4 && rc.canMove(dir)) {
                if (dist < bestDist || (dist == bestDist && SquareManager.penalty33 < bestPenalty)) {
                    bestPenalty = SquareManager.penalty33;
                    bestDist = dist;
                    bestDir = dir;
                }
            }
