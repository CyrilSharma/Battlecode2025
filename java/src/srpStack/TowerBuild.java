...
public class TowerBuild {
    ...
    public static void markCorners() throws GameActionException {
        ...
        {
            MapLocation tmp = markingCorners.add(corners[0]);
        ...
        {
            MapLocation tmp = markingCorners.add(corners[1]);
            if (rc.canSenseLocation(tmp)) {
                MapInfo s = rc.senseMapInfo(tmp);
                if (s.getMark() == PaintType.EMPTY) {
                    if (rc.canMark(tmp)) rc.mark(tmp, true);
        ...
        {
            MapLocation tmp = markingCorners.add(corners[2]);
            if (rc.canSenseLocation(tmp)) {
                MapInfo s = rc.senseMapInfo(tmp);
                if (s.getMark() == PaintType.EMPTY) {
                    if (rc.canMark(tmp)) rc.mark(tmp, true);
        ...
        {
            MapLocation tmp = markingCorners.add(corners[3]);
            if (rc.canSenseLocation(tmp)) {
                MapInfo s = rc.senseMapInfo(tmp);
                if (s.getMark() == PaintType.EMPTY) {
                    if (rc.canMark(tmp)) rc.mark(tmp, true);
    ...
    public static MapLocation getRuin(MapInfo[] near) throws GameActionException {
        ...
        if ((prevRuin != null)
            && rc.canSenseLocation(prevRuin) && last[prevRuin.x][prevRuin.y] < rc.getRoundNum()
            && ((rc.getType() == UnitType.MOPPER && (seeTaintedRuin(prevRuin))
             || (rc.getType() == UnitType.SOLDIER && seeIncompleteRuin(prevRuin))))) {
            return prevRuin;
        } 
        return best;
    }
    ...
    public static boolean isFarm(MapLocation ruin) throws GameActionException {
        ...
        tmp = ruin.add(TowerBuild.corners[0]);
        if (rc.canSenseLocation(tmp)) {
        ...
        tmp = ruin.add(TowerBuild.corners[1]);
        if (rc.canSenseLocation(tmp)) {
            s = rc.senseMapInfo(tmp);
            if (s.getMark() != PaintType.EMPTY) {
                return true;
        ...
        tmp = ruin.add(TowerBuild.corners[2]);
        if (rc.canSenseLocation(tmp)) {
            s = rc.senseMapInfo(tmp);
            if (s.getMark() != PaintType.EMPTY) {
                return true;
        ...
        tmp = ruin.add(TowerBuild.corners[3]);
        if (rc.canSenseLocation(tmp)) {
            s = rc.senseMapInfo(tmp);
            if (s.getMark() != PaintType.EMPTY) {
                return true;
