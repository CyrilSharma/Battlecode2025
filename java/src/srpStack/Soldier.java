...
public class Soldier {
    ...
    public static void moneyPattern() throws GameActionException {
        ...
        for (int i = near.length; --i >= 0; ) {
            ...
            if (near[i].getMark() == PaintType.ALLY_SECONDARY) return;
        }
    ...
    public static boolean nearbyFarm(MapLocation loc) throws GameActionException {
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[4][4];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[4][3];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[4][2];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[4][1];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[4][0];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[3][4];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[3][3];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[3][2];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[3][1];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[3][0];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[2][4];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[2][3];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[2][1];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[2][0];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[1][4];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[1][3];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[1][2];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[1][1];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[1][0];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[0][4];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[0][3];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[0][2];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[0][1];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
        ...
        if (rc.canSenseLocation(tmp)) {
            MapInfo mi = rc.senseMapInfo(tmp);
            boolean b = TowerBuild.moneyTower[0][0];
            if (mi.getPaint() == PaintType.EMPTY || (mi.getPaint().isAlly() && b != (mi.getPaint() == PaintType.ALLY_SECONDARY))) {
                if (rc.canAttack(tmp)) {
                    rc.attack(tmp, b);
                    return true;
