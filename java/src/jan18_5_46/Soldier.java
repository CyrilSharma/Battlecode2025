...
public class Soldier {
    ...
    //:clown:
    public static int checkX[] = {0, 0, 0, 1, 1, 2, 1, 0, 0, -1, -1, -2, -1};
    public static int checkY[] = {0, 1, 2, 1, 0, 0, -1, -1, -2, -1, 0, 0, 1};
    ...
    public static boolean shouldUseSecond(MapLocation loc, MapLocation center) throws GameActionException {
        return resourcePat[2 + (center.x - loc.x)][2 + (center.y - loc.y)];
    }
    ...
    public static void makeResourcePatch() throws GameActionException {
        ...
        rc.setIndicatorString("my f goal is " + goal);
        if (goal != null) {
